...
/* package tic-tac-0.1.0.0 */
#ifndef VERSION_tic_tac
#define VERSION_tic_tac "0.1.0.0"
#endif /* VERSION_tic_tac */
#ifndef MIN_VERSION_tic_tac
#define MIN_VERSION_tic_tac(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_tic_tac */
...
#define CURRENT_PACKAGE_KEY "tic-tac-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "tic-tac-0.1.0.0-inplace"
